...
window_size=3
lstm_units=4
csv_filename='international-airline-passengers.csv' # Per-month international passenger count
...
print("Timeseries train shape",timeseries_train.shape)
print("Timeseries test shape",timeseries_test.shape)
